...
public class GetLavatoryReviewsRequest extends SpringAndroidSpiceRequest<Reviews> {

    private static final String FETCH_REVIEWS_SERVICE_URL = "http://lavlocdb.herokuapp.com/fetchreviews.php";
    ...
    public GetLavatoryReviewsRequest(String userId, String lavatoryId, String page, String sortParam, String sortDirection) {
        super(Reviews.class);
    ...
    public Reviews loadDataFromNetwork() throws Exception {
        Uri.Builder uriBuilder = Uri.parse(FETCH_REVIEWS_SERVICE_URL)
                .buildUpon();
        ...
        uriBuilder.appendQueryParameter(SORT_DIRECTION_SERVER_KEY, sortDirection);
