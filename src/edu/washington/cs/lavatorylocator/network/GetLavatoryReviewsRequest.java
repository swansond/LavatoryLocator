...
public class GetLavatoryReviewsRequest extends
     ...
     *            the sort direction
     */
    public GetLavatoryReviewsRequest(String userId, String lavatoryId,
            String page, String sortParam, String sortDirection) {
        super(Reviews.class);
    ...
    public Reviews loadDataFromNetwork() throws Exception {
        ...
        uriBuilder.appendQueryParameter(SORT_DIRECTION_SERVER_KEY,
                sortDirection);
